...
void solve() {
    ...
    rep(i,1,n+1)
    {
        pref1[i]=pref1[i-1]+(s[i-1]=='1'&& t[i-1]=='0');
        pref2[i]=pref2[i-1]+(s[i-1]=='0'&& t[i-1]=='1');
    }
    while(q--)
    {
        int l,r;cin>>l>>r;
        if(((r-l+1)-(pref1[r]-pref1[l-1])>=pref1[r]-pref1[l-1]) &&((r-l+1)-(pref2[r]-pref2[l-1])>=pref2[r]-pref2[l-1]) )
            cout<<"YES"<<endl;
        else cout<<"NO"<<endl;
    }
}
