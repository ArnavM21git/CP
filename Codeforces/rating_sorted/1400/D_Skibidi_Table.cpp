...
void solve() {
    ...
    while(q--)
    {
        ...
        if(op =="->")
        {
            ...
            int add=0;
            auto fn=[&](auto &&self,int x,int y,int nn)
            {
                if(nn==1)
                {
                    if (x == 1 && y == 1) add += 1;
                    else if (x == 2 && y == 2) add += 2;
                    else if (x == 2 && y == 1) add += 3;
                    else if (x == 1 && y == 2) add += 4;
                    return;
                }
                int half=(1LL<<nn-1);
                int area=(1LL<<2*nn-2);
                ...
                {
                    add+=area;
                    self(self,x-half,y-half,nn-1);
                }
                else if(x<=half && y>half)
                {
                    add+=3*area;
                    self(self,x,y-half,nn-1);
                }
                else{
                    add+=2*area;
                    self(self,x-half,y,nn-1);
                }
            };
            fn(fn,x,y,n);
            cout<<add<<endl;
            ...
            int d;cin>>d;
            int x=1,y=1;
            auto fn=[&](auto &&self,int dd,int nn)
            {
                if(nn==1)
                {
                    if(dd==1) {}
                ...
                {
                    x+=half;y+=half;
                    self(self,dd-area,nn-1);
                }
                else if(v==2)
                {
                    x+=half;
                    self(self,dd-2*area,nn-1);
                }
                else{
                    y+=half;
                    self(self,dd-3*area,nn-1);
                }
            };
            fn(fn,d,n);
            cout<<x<<" "<<y<<endl;
